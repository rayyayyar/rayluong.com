...
<?php startblock('main') ?>
  ...
  <section>
    ...
    <div class="row">
      ...
      <p>If I were adopting for the first time, I think I would love to use a tool like this. PetLove walks me through the entire process from what my preferences are, to search, and post-adoption tips. The design addresses all of the major themes revealed in research: search, commitment, interaction, and education.</p>
      
      <strong>The final output isn’t perfect.</strong>
      <p>There are some assumptions I’m making about how useful the initial questionnaire is. We’re optimizing for the persona of a young individual who’s adopting for the first time. If it were someone who knew exactly what they wanted, they would likely prefer to jump straight to a database of pets and start filtering. What’s missing from the design is some way to visually distinguish pets I’ve seen versus pets I haven’t. This is especially important when I return after a search alert emails me. I’m also very curious about what other data we could use to better match a pet with an owner. </p>
