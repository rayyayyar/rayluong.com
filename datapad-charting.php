<?php
  $project_id = "dp-charting";
  $cover_style = "dark-cover";
  $company = "DataPad";
  $company_link = "datapad";
  $title = "Charting";
  $next_project = "Dashboarding";
  $next_project_address = "datapad-dashboarding";
  $columns = "8";
...
<?php startblock('main') ?>
  ...
  <!--    Solution-->
    <section class="solution">
      ...
      <div class="row">
        <div class="image column">
          <a href="img/charting-solution/charting.gif" data-fluidbox><img src="img/charting-solution/charting.gif" alt="Charting Solution" title="Charting Solution" /></a>
      ...
      <div class="row">
        <div class="image column">
          <a href="img/charting-solution/charting-anim.gif" data-fluidbox><img src="img/charting-solution/charting-anim.gif" alt="" title="" /></a>
    ...
    <section>
      ...
      <div class="row">
        <div class="image column">
          <a href="img/charting-solution/charting-sidebyside.png" data-fluidbox><img src="img/charting-solution/charting-sidebyside.png" alt="" title="" /></a>
